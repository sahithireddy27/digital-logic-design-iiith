...
public class NandGate extends Element {
     ...
     */
    NandGate(int id, String type, int inpId, int outId, Point coord) {
        elementID = id;
        elementType = type;
    ...
    public void draw(Graphics g, Point p){
        ...
        arc2.setFrame(p.x-(ele.width/2)-delta.width, p.y-20-delta.height, ele.width-20, ele.height-20);
        ...
        inputList.elementAt(0).draw(g, new Point(p.x-20, p.y-20));
